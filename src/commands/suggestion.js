...
module.exports = {
    data: new SlashCommandBuilder()
    	.setName('suggestion')
    	.setDescription('Suggest us something for the USF Bot')
    	.addStringOption(option=>option.setName('type').setDescription('What you want to suggest').setRequired(true).addChoices(
            {name: 'Command', value: 'command'},
            {name: 'Option', value: 'option'},
            {name: 'Command Changes', value: 'change'},
